...
const DealPage = ({ params }: { params: { dealId: string } }) => {
  const router = useRouter();
  const { user } = useUser();

  const data = useQuery(api.deals.get, {
    dealId: params.dealId as Id<"deals">,
  });
              ...
              <div className="w-[328px] mx-auto rounded-sm overflow-hidden">
                ...
                >
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      EMD stands for Earnest Money Deposit. In the context of
                      real estate transactions, an Earnest Money Deposit is a
                      sum of money provided by a buyer to the seller as a
                      demonstration of their serious intent and commitment to
                      purchase a property. The EMD is typically submitted along
                      with an offer to buy a property and is held in an escrow
                      account.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                      ...
                      managing the details and paperwork involved in a real
                      estate transaction. Their role is to ensure that the
                      process runs smoothly by organizing and coordinating
                      various elements, including communication between parties,
                      document preparation, and adherence to timelines.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </div>
                ...
                <ul className="mt-8 p-4 space-y-2 text-black-100 text-pretty text-left font-light tracking-widest text-xl border border-black-50 rounded-sm">
                  ...
                  <li>
                    <div className={`flex justify-between`}>
                      <p>Amount:</p>
                      <p>
                        ${new Intl.NumberFormat().format(data.amountNeeded)}
                      </p>
